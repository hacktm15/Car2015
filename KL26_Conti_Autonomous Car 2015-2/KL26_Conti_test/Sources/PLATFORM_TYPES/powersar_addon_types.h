 ...
 * Filename:   $Workfile:   Powersar_Addon_Types.h  $
 * Revision:   $Revision:   1.1  $
 * Author:     $Author:   uidm3647  $
 * Date:       $Date:   Jul 13 2010 16:32:26  $
 * Changes:    $Log:   K:/LIB01/0_GEN/PI/TCX/code/Powersar_Addon_Types.h_v  $
 * 
 *    Rev 1.1   Jul 13 2010 16:32:26   uidm3647
 * TCX-SWCN-6: Update in generic Addon header file (powersar_addon_types.h).
 * 
 ****************************************************************************/
