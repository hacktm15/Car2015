...
const Io_Tpm_PwmChannelCnfStruct Io_Tpm_Pwm_Ch_Cnf[]=
{
		...
		//{   CNF_TPM1_CHANNEL0,  IO_TPM_INIT_ENABLE_ON,  IO_PWM_TYPE_A,  IO_TPM_INIT_LEVEL_LOW, 	IO_TPM_PERCENT_TO_4000HEX(0) },
		//{   CNF_TPM1_CHANNEL1,  IO_TPM_INIT_ENABLE_ON,  IO_PWM_TYPE_A,  IO_TPM_INIT_LEVEL_LOW, 	IO_TPM_PERCENT_TO_4000HEX(0) },
...
const Io_Tpm_DcmChannelCnfStruct Io_Tpm_Dcm_Ch_Cnf[]=
{
		...
		{ CNF_TPM0_CHANNEL1,	IO_TPM_CAPTURE_RISING_OR_FALLING,	CNF_IO_PCS_P0A_04,	 IO_TPM_INIT_ENABLE_ON,		IO_TPM_DMA_REQUEST_OFF,	  STD_HIGH	 	},
		{ CNF_TPM0_CHANNEL2,	IO_TPM_CAPTURE_RISING_OR_FALLING,	CNF_IO_PCS_P0A_05,	 IO_TPM_INIT_ENABLE_ON,		IO_TPM_DMA_REQUEST_OFF,	  STD_HIGH 	 	},
...
const Io_Tpm_DeviceCnfStruct Io_Tpm_Dev_Cnf[]=
{
		...
		},
		{
				...
				/*4*/ IO_TPM_COUNT_UP,
				/*5*/ IO_TPM_TOF_INTERRUPT_OFF,
				/*6*/ IO_TPM_PERIOD_TO_TICKS(40000,IO_TPM_PRESCALER16)
		...
		},
		{
				...
				/*4*/ IO_TPM_COUNT_UP,
				/*5*/ IO_TPM_TOF_INTERRUPT_OFF,
				/*6*/ IO_TPM_PERIOD_TO_TICKS(10000,IO_TPM_PRESCALER8)
				/* Tpwm = 10 ms, Fpwm = 100 Hz */
		}
