...
/* Macros for rough car speed calculation */
//#define ALGO_ROBO_SC_CALCULATE_CAR_SPEED(dutycycle)			(uint16)((uint32)(50 * ALGO_ROBO_SC_RPS_5V * ALGO_ROBO_SC_WHEEL_LENGTH_MM * ALGO_ROBO_SC_WEIGHT_FACTOR1) / (ALGO_ROBO_SC_WEIGHT_FACTOR2 * 100))
...
/* end of Macros for rough car speed calculation */
